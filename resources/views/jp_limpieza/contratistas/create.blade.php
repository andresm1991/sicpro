...
@section('content')
    ...
    <section class="content" style="padding-bottom: 20px; margin:15px;">
        <div class="container-fluid">
            {!! Form::open([
                'route' => [
                    'jp.limpieza.contratistas.store',
                    [
                        'proyecto' => $proyecto,
                    ],
                ],
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <div class="row d-flex justify-content-between">
                            <div class="col-md-8">
                                <h4>orden de trabajo #{!! Form::text('numero', $numero, ['class' => 'no-border', 'readonly' => true]) !!}</h4>
                            ...
                            <div class="col-md-2 ">
                                <button class="btn btn-dark btn-options btn-block" form="form_contratista">Guardar</button>
                            </div>
                        </div>
                    </li>
                </ul>

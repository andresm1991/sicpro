...
@section('content')
    ...
    <section>
        <div class="container-fluid">
            <form action="" method="POST" class="form-horizontal" target="__blank" autocomplete="off"
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                {{ Form::select('producto', getProdutosJPLimpieza(), '', ['class' => 'form-control select2-tag', 'data-placeholder' => 'seleccione o ingrese producto', 'data-allow-clear' => 'true']) }}
                            </div>

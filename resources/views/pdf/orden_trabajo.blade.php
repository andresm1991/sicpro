...
<head>
    ...
    <style>
        ...
        .watermark img {
            width: 80%;
            /* Ajusta la imagen al 80% del ancho de la página */
            height: auto;
            /* Mantiene la relación de aspecto */
            position: absolute;
            top: 25%;
            /* Ajustar el margen superior para centrar */
            left: 10%;
            /* Ajustar el margen izquierdo para centrar */
            opacity: 0.2;
            /* Transparencia */
        }
        ...
        .col-sm-12 {
            float: left;
            /* Flotar las columnas a la izquierda */
            padding-right: 15px;
            padding-left: 15px;
        }
...
<body>
    ...
    <div class="row clearfix">
        ...
        <div class="col-sm-6">
            <p><strong class="title">Contratista:</strong> <span class="text-content">{{ $info['contratista'] }}</span>
            </p>

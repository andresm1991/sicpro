        ...
        <div class="">
            ...
            <div class="card">
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <a href="{{ route('marketing.seguimiento.ventas.create') }}" class="btn btn-dark btn-sm">
                                    <i class="fa-light fa-plus"></i> Nueva seguimiento
                                </a>
                            </div>
                        </div>
                        <div class="col-md-8 col-12 ">
                            <div class="form-group form-search form-icon col-md-10 col-12 float-right p-0">
                                ...
                                <input type="text" name="seguimientos_search" class="form-control form-control-round"
                    ...
                    @include('partials.pagination', ['paginator' => $seguimientos, 'interval' => 5])
                </div>
            </div>
        </div>
    </section>

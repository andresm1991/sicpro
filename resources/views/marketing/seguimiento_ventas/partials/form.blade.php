                     ...
                     <div class="col-12 col-lg-8 ml-auto mr-auto mb-4">
                         <div class="multisteps-form__progress">
                             <button class="multisteps-form__progress-btn js-active" type="button"
                                 title="User Info">Información general</button>
                             <button class="multisteps-form__progress-btn" type="button"
                                 title="Address">Dirección</button>
                             <button class="multisteps-form__progress-btn" type="button" title="Order Info">Información
                                 del pedido</button>
                             <button class="multisteps-form__progress-btn" type="button" title="Comments">Comentarios
                             </button>
                         </div>
                     </div>
                 </div>

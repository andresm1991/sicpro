        ...
        <div class="container-fluid">
            <div class="card">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <div class="row d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-md-2 ">
                                <button class="btn btn-dark btn-options btn-block" id="btn-guardar"
                                    form="form_reposicion">Guardar</button>
                            </div>
                        </div>
                    </li>
                </ul>
                <div class="card-body">
                    ...
                    {!! Form::model($reposicion, [
                        'route' => ['solicitud.reposicion.update', $reposicion->id],

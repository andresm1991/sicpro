<div class="row">
    <div class="col-md-4 col-12">
        <div class="form-group">
            <a href="javascript:void(0);" class="btn btn-dark btn-sm" data-toggle="modal" data-backdrop="static"
                data-keyboard="false" data-target="#pagoSemanalModal">
    ...
    <div class="col-md-8 col-12 ">
        <div class="form-group form-search form-icon col-md-10 col-12 float-right p-0">
            ...
            <input type="text" name="resumen_pagos_search" id="pendientes" class="form-control form-control-round"
                placeholder="Buscar pago....">
        </div>
    </div>
</div>
<div class="table-responsive">
    <table class="table table-bordered table-hover" id="resumen_pagos_pendientes_table">
        ...
        <tbody>
            @forelse ($resumen_pagos_pendientes as $resumen)
                <tr id="{{ $resumen->id }}">
...
@include('partials.pagination', ['paginator' => $resumen_pagos_pendientes, 'interval' => 5])

        ...
        <div class="container-fluid">
            <div class="card">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-10">
                                <h4 class="mt-2 font-weight-bold">Formulario de Eventualidad</h4>
                                <h6>Fecha: {{ $solicitud->fecha_solicitud ?? date('Y-m-d') }}</h6>
                            </div>
                ...
                <div class="card-body">
                    ...
                    {!! Form::open([
                        'route' => ['solicitud.eventualidad.store'],
                    ...
                    @include('solicitudes.eventualidad.partials.form')

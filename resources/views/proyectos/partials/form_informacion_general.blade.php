<div class="row">
    <div class="col-sm-8">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <div class="form-group">
                    <label class="col-form-label font-weight-bold">Área del lote m² <i
                            class="fa-regular fa-asterisk fa-2xs"></i></label>
        ...
        <div class="row">
            <div class="col-md-6 col-12">
                <div class="form-group">
                    <label class="col-form-label font-weight-bold">Área de construcción m² <i
                            class="fa-regular fa-asterisk fa-2xs"></i></label>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <div class="form-group">
                    <label class="col-form-label font-weight-bold">Área de construcción por unidad m²</label>
